...
function corrupt(target, ctx) {
    return function () {
        console.log("".concat(this.name, " is corrupted"));
    };
}
var Android = function () {
    ...
    return _a = /** @class */ (function () {
            function Android() {
                this.name = (__runInitializers(this, _instanceExtraInitializers), "Lily");
            }
            Android.prototype.greet = function () {
